...
CREATE TABLE `nivel_instrucao` (
  `nivel_instrucao_id` int(11) NOT NULL AUTO_INCREMENT,
  `nivel_instrucao_descricao` varchar(45) NOT NULL,
  `nivel_instrucao_status` tinyint(1) NOT NULL,
  PRIMARY KEY (`nivel_instrucao_id`)
...
INSERT INTO `nivel_instrucao` VALUES (1,'Ensino Médio',1),(2,'Ensino Médio',1);
